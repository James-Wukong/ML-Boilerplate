...
# COPY --chown=machine-learning:root . /usr/src/app/ml_skeleton
COPY ../ml_skeleton ${PROJECT_BASE_DIR}/ml_skeleton

WORKDIR ${PROJECT_BASE_DIR}/ml_skeleton
...
# COPY --from=poetry-builder ${PROJECT_BASE_DIR}/ml_skeleton ${PROJECT_BASE_DIR}/skeleton
